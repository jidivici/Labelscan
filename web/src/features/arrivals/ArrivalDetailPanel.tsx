      ...
      {detail && <>
        <section className="detail-hero">
          <div className="detail-visual">
            <ArrivalImage batchId={detail.batch_id} available={detail.photo_available} alt="Étiquette du produit" rotationDegrees={detail.photo_rotation_degrees} baseRotationDegrees={detail.photo_base_rotation_degrees} variant="source" eager onOpen={setPhotoViewerUrl} />
          </div>
