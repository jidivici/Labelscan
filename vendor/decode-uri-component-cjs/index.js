...
// Upstream: decode-uri-component@0.5.0 (MIT).
// Compatibility-only change: CommonJS export for query-string@7.
...
function customDecodeURIComponent(input) {
  ...
  // Add `%C2` last so it does not replace the combinator before everything else.
  replaceMap['%C2'] = '\uFFFD';
