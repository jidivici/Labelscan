"""Install the local LabelScan photo-grounded demonstration data.
...
arrivals backed by the sanitized label photographs in ``server/demo/images``.
Missing or ambiguous facts are displayed as ``NC``; no shelf life, origin,
allergen, GTIN, or date role is inferred. All profile fields remain visible.
"""
...
def load_demo_passwords() -> dict[str, str]:
    ...
    if not isinstance(raw, dict) or set(raw) != set(DEMO_USERS):
        raise RuntimeError(
            "demo credentials must contain exactly the six demo usernames"
        )
...
ARRIVALS = (
    DemoArrival(
        ...
        "grondin-rouge.jpg",
        {
            "commercial_designation": "GRONDIN RGE",
            "scientific_name": "ASPITRIGLA CUCULUS",
            "producer_name": "NC",
            "reseller_brand": "COOPERATIVE U VENDARGUES",
            "batch_number": "15426",
            "origin_country": "NC",
            "expiry_date": "NC",
            "packaging_date": "2026-06-03",
            "storage_temperature": "0 à 2 °C",
            "allergens": "NC",
            "health_mark": "FR 35.177.014 CE",
            "weight": "2.00 kg",
            "gtin": "NC",
            "FAO_area": "FAO 27 VII",
            "production_method": "wild_caught",
            "fishing_gear_or_farming_method": "CHALUT",
        },
        True,
    ),
    DemoArrival(
        ...
        "merlan-filet.jpg",
        {
            "commercial_designation": "MERLAN FILET",
            "scientific_name": "MERLANGIUS MERLANGUS",
            "producer_name": "G&J JACK SEAFOODS",
            "reseller_brand": "MERICQ",
            "batch_number": "F 12P",
            "origin_country": "UK",
            "expiry_date": "NC",
            "packaging_date": "NC",
            "storage_temperature": "0 à 2 °C",
            "allergens": "NC",
            "health_mark": "GB BB004",
            "weight": "3 kg",
            "gtin": "NC",
            "FAO_area": "FAO 27/IVa",
            "production_method": "wild_caught",
            "fishing_gear_or_farming_method": "chaluts",
        },
    ),
    DemoArrival(
        "julienne",
        ...
        "dos-julienne.jpg",
        {
            "commercial_designation": "Dos de Julienne",
            "scientific_name": "Molva molva",
            "producer_name": "WHITELINK SEAFOODS LTD",
            "reseller_brand": "SAS MERICQ AGEN",
            "batch_number": "400111",
            "origin_country": "Ecosse",
            "expiry_date": "NC",
            "packaging_date": "2026-06-17",
            "storage_temperature": "0 à 2 °C",
            "allergens": "Poisson",
            "health_mark": "GB BB027",
            "weight": "3 kg",
            "gtin": "NC",
            "FAO_area": "FAO27",
            "production_method": "wild_caught",
            "fishing_gear_or_farming_method": "Chaluts de fond à panneaux (OTB)",
        },
    ),
    DemoArrival(
        "truite",
        ...
        "truite.jpg",
        {
            "commercial_designation": "Truite PAC U",
            "scientific_name": "Oncorhynchus Mykiss",
            "producer_name": "Pisciculture FONT-ROME",
            "reseller_brand": "COOPERATIVE U ENSEIGNE VENDARGUES V2",
            "batch_number": "170",
            "origin_country": "France",
            "expiry_date": "NC",
            "packaging_date": "2026-06-19",
            "storage_temperature": "0 à 2 °C",
            "allergens": "NC",
            "health_mark": "FR 07 019 003 UE",
            "weight": "NC",
            "gtin": "NC",
            "FAO_area": "NC",
            "production_method": "farmed",
            "fishing_gear_or_farming_method": "Pisciculture",
        },
    ),
    DemoArrival(
        "maquereau",
        ...
        "maquereau.jpg",
        {
            "commercial_designation": "Maquereau 300/500 QMC PF C/3K",
            "scientific_name": "SCOMBER SCOMBRUS",
            "producer_name": "MERICQ La Rochelle",
            "reseller_brand": "NC",
            "batch_number": "256541",
            "origin_country": "NC",
            "expiry_date": "NC",
            "packaging_date": "2026-06-15",
            "storage_temperature": "0 à 2 °C",
            "allergens": "NC",
            "health_mark": "FR 17-300-147 CE",
            "weight": "3.000 kg",
            "gtin": "3700161210047",
            "FAO_area": "ATLANTIQUE NORD EST, SOUS ZONE VIII ET AUTRES SOUS-ZONES",
            "production_method": "wild_caught",
            "fishing_gear_or_farming_method": "NC",
        },
    ),
    DemoArrival(
        "cabillaud",
        ...
        "cabillaud.jpg",
        {
            "commercial_designation": "Cabillaud - Dos de cabillaud",
            ...
            "storage_temperature": "0 à 2 °C",
            "allergens": "NC",
            "health_mark": "IS A-003 EFTA",
            "weight": "3.0 kg",
            "gtin": "NC",
            "FAO_area": "FAO area 27",
            "production_method": "wild_caught",
            "fishing_gear_or_farming_method": "NC",
        },
    ),
    DemoArrival(
        ...
        "espadon-longe.jpg",
        {
            "commercial_designation": "ESPADON Longe",
            "scientific_name": "Xiphias gladius",
            "producer_name": "MEDI-PECHE SET",
            "reseller_brand": "NC",
            "batch_number": "107083 - 21526",
            "origin_country": "NC",
            "expiry_date": "2026-08-12",
            "packaging_date": "2026-08-03",
            "storage_temperature": "0 à 2 °C",
            "allergens": "NC",
            "health_mark": "FR 34-108-593 CE",
            "weight": "4.500 kg",
            "gtin": "NC",
            "FAO_area": "27.VIII",
            "production_method": "wild_caught",
            "fishing_gear_or_farming_method": "Palangres calées",
        },
    ),
    DemoArrival(
        "encornet",
        ...
        "encornet-rouge.jpg",
        {
            "commercial_designation": "Encornet rouge",
            "scientific_name": "Illex coindetii",
            "producer_name": "MICHEL MAREE",
            "reseller_brand": "U ENSEIGNE VENDARGUES",
            "batch_number": "MM215",
            "origin_country": "NC",
            "expiry_date": "NC",
            "packaging_date": "NC",
            "storage_temperature": "0 à 2 °C",
            "allergens": "NC",
            "health_mark": "FRANCE 34.108.534 C.E.",
            "weight": "3.000 kg",
            "gtin": "NC",
            "FAO_area": "FAO 37.1",
            "production_method": "wild_caught",
    ...
    DemoArrival(
        ...
        "saumon.jpg",
        {
            "commercial_designation": "SAUMON FJORD NV 4/5",
            "scientific_name": "Salmo salar",
            "producer_name": "NC",
            "reseller_brand": "COOPERATIVE U VENDARGUE",
            "batch_number": "26167",
            "origin_country": "Norvege",
            "expiry_date": "NC",
            "packaging_date": "NC",
            "storage_temperature": "0 à 2 °C",
            "allergens": "NC",
            "health_mark": "FR 85.100.002 CE",
            "weight": "8.830 kg",
            "gtin": "NC",
            "FAO_area": "NC",
            "production_method": "farmed",
...
def audit(conn, actor_id: str, action: str) -> None:
    set_audit_context(
        ...
        actor_id=actor_id,
        action=action,
        correlation_id="labelscan-demo",
        trace_id="labelscan-demo",
    )
...
def seed() -> None:
    ...
    with engine.begin() as conn:
        ...
        bootstrap_actor = conn.execute(
            text(
                "SELECT id::text FROM identity.app_user WHERE organization_id=:org AND active=true ORDER BY CASE role WHEN 'super_admin' THEN 0 ELSE 1 END LIMIT 1"
            ),
            {"org": organization_id},
        ).scalar_one_or_none()
        bootstrap_actor = bootstrap_actor or stable_id("user:super_admin")
        super_id = upsert_user(
            conn,
            organization_id,
            "super_admin",
            "super_admin",
            demo_passwords["super_admin"],
            bootstrap_actor,
        )
        admin_id = upsert_user(
            conn, organization_id, "admin", "admin", demo_passwords["admin"], super_id
        )
        ...
        existing = conn.execute(
            text(
                "SELECT id::text, code FROM identity.store WHERE organization_id=:org ORDER BY created_at LIMIT 1"
            ),
            {"org": organization_id},
        ).first()
        ...
        for city, label in (
            ...
            store_id = (
                existing[0]
                if city == "FREJUS" and existing
                else stable_id(f"store:{city}")
            )
            ...
            store_id = str(
                conn.execute(
                    text(
                        "SELECT id FROM identity.store WHERE organization_id=:org AND code=:code"
                    ),
            ...
            portal_id = str(
                conn.execute(
                    text(
                        "SELECT id FROM identity.business_portal WHERE organization_id=:org AND store_id=:store_id AND profession_code='poissonnerie'"
                    ),
                    {"org": organization_id, "store_id": store_id},
                ).scalar_one()
            )
        ...
        for city in stores:
            ...
            conn.execute(
                text(
                    "UPDATE identity.user_portal_assignment SET active=false, updated_at=clock_timestamp() WHERE organization_id=:org AND user_id=:user_id AND portal_id<>:portal_id AND active=true"
                ),
                {"org": organization_id, "user_id": manager_id, "portal_id": portal_id},
            )
            conn.execute(
                text("""
            ...
            """),
                {
                    "id": stable_id(f"assignment:{username}"),
                    "org": organization_id,
                    "user_id": manager_id,
                    "portal_id": portal_id,
                    "created_by": admin_id,
        ...
        conn.execute(
            text(
                "UPDATE identity.auth_session SET revoked_at=COALESCE(revoked_at, clock_timestamp()) WHERE organization_id=:org"
            ),
            {"org": organization_id},
        )
        ...
        conn.execute(
            text(
                "DELETE FROM traceability.arrival_projection WHERE organization_id=:org"
            ),
            {"org": organization_id},
        )
        ...
        for index, arrival in enumerate(ARRIVALS):
            ...
            """),
                {
                    "id": stable_id(f"artifact:{arrival.key}"),
                    "recorded_at": recorded_at,
            ...
            conn.execute(
                ...
                INSERT INTO traceability.batch
                    (id, lot_code, species_scientific, fao_area_code, production_method,
                     ...
                     business_portal_id, trade_code_snapshot, trade_profile_version, captured_by_user_id)
                VALUES (:id, :lot, :scientific, :fao, :method,
                        CAST(NULLIF(:use_by, 'NC') AS date),
                        CAST(NULLIF(:packaging, 'NC') AS date),
            ...
            """),
                {
                    "id": batch_id,
                    "lot": fields["batch_number"],
                    "scientific": fields["scientific_name"],
                    "fao": fields["FAO_area"],
                    "method": fields["production_method"],
                    "use_by": fields["expiry_date"],
                    "packaging": fields["packaging_date"],
                    "status": "flagged" if arrival.flagged else "registered",
                    "ingestion_id": ingestion_id,
                    "run_id": run_id,
                    "correlation": correlation,
                    "recorded_at": recorded_at,
    ...
    print(
        f"LabelScan demo installed: 4 city stores, 6 accounts, {len(ARRIVALS)} photographed arrivals"
    )
